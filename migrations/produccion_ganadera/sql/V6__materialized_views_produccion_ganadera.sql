...
SELECT
    sg.id AS fid,
    make_date(sg.anio, 1, 1) AS fecha,
...
COMMENT ON COLUMN vm_prod_pecuaria_geo.fecha IS 'Fecha de referencia anual de la produccion pecuaria.';
...
COMMENT ON COLUMN vm_prod_pecuaria_geo.cvegeo IS 'Clave INEGI del municipio.';
