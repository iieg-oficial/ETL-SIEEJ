...
COMMENT ON COLUMN fuentes_limites_municipales.nombre IS 'Nombre legible de la fuente de limite municipal.';
...
COMMENT ON COLUMN fuentes_limites_municipales.version IS 'Version o procedencia documentada de la fuente territorial cuando esta disponible.';
...
COMMENT ON COLUMN edafologias.source_version IS 'Version del conjunto fuente INEGI. Para esta implementacion corresponde a Serie III; una publicacion futura debe registrarse como nueva version.';
COMMENT ON COLUMN edafologias.source_objectid IS 'OBJECTID original de la capa fuente. Es clave logica junto con source_version para Serie III, pero no se asume estable entre publicaciones futuras.';
...
COMMENT ON COLUMN edafologias.shape_leng_origen IS 'Shape_Leng original reportado por la fuente antes de normalizacion espacial.';
COMMENT ON COLUMN edafologias.shape_area_origen IS 'Shape_Area original reportado por la fuente antes de recorte y reproyeccion.';
COMMENT ON COLUMN edafologias.source_name IS 'Nombre institucional de la fuente: INEGI Edafologia historica 1:250 000 Serie III.';
COMMENT ON COLUMN edafologias.source_url IS 'URL oficial configurada para la descarga de la fuente; no contiene credenciales.';
COMMENT ON COLUMN edafologias.source_file_name IS 'Nombre del archivo ZIP fuente conservado para trazabilidad.';
COMMENT ON COLUMN edafologias.source_file_sha256 IS 'SHA-256 del ZIP fuente validado antes de transformar y cargar.';
COMMENT ON COLUMN edafologias.source_downloaded_at IS 'Fecha/hora de descarga o reutilizacion verificable del archivo fuente.';
COMMENT ON COLUMN edafologias.processed_at IS 'Fecha/hora de procesamiento que produjo la geometria canonica cargada.';
COMMENT ON COLUMN edafologias.fecha_actualizacion IS 'Fecha operativa de actualizacion del registro en el pipeline.';
COMMENT ON COLUMN edafologias.geom IS 'Geometria canonica MultiPolygon en EPSG:6368. Se reparan geometrias fuente cuando es tecnicamente procedente antes del recorte.';
...
COMMENT ON COLUMN edafologia_fragmentos_municipales.municipality_cvegeo IS 'Clave municipal cvegeo usada como referencia logica a cvegeo_municipalities; no existe FK fisica porque cvegeo vive en otra base.';
COMMENT ON COLUMN edafologia_fragmentos_municipales.source_version IS 'Version de la fuente edafologica usada para reconstruir idempotentemente el overlay.';
...
COMMENT ON COLUMN edafologia_fragmentos_municipales.area_m2 IS 'Superficie del fragmento de interseccion en metros cuadrados, calculada en EPSG:6368 con DOUBLE PRECISION.';
COMMENT ON COLUMN edafologia_fragmentos_municipales.area_ha IS 'Superficie del fragmento en hectareas, derivada de area_m2.';
COMMENT ON COLUMN edafologia_fragmentos_municipales.pct_poligono_fuente IS 'Porcentaje del area del poligono edafologico canonico representada por este fragmento. Denominador: area total del poligono fuente canonico.';
COMMENT ON COLUMN edafologia_fragmentos_municipales.pct_municipio_total IS 'Porcentaje del territorio municipal cubierto por este fragmento. Denominador: area total del municipio de la fuente de limite correspondiente.';
COMMENT ON COLUMN edafologia_fragmentos_municipales.pct_cobertura_edafologica IS 'Porcentaje de la cobertura edafologica municipal representada por este fragmento. Denominador: suma de fragmentos edafologicos positivos del municipio para la misma fuente territorial.';
...
COMMENT ON COLUMN edafologia_fragmentos_municipales.geom IS 'Geometria MultiPolygon de la interseccion real entre poligono edafologico y municipio, en EPSG:6368.';
...
COMMENT ON COLUMN edafologia_resumenes_municipales.municipality_cvegeo IS 'Clave cvegeo municipal para consulta directa del resumen.';
COMMENT ON COLUMN edafologia_resumenes_municipales.source_version IS 'Version de la fuente edafologica resumida.';
...
COMMENT ON COLUMN edafologia_resumenes_municipales.area_m2 IS 'Suma de area_m2 de los fragmentos del grupo de agregacion.';
COMMENT ON COLUMN edafologia_resumenes_municipales.area_ha IS 'Suma de area_ha de los fragmentos del grupo de agregacion.';
COMMENT ON COLUMN edafologia_resumenes_municipales.pct_municipio IS 'Suma de pct_municipio_total de los fragmentos del grupo de agregacion.';
COMMENT ON COLUMN edafologia_resumenes_municipales.fragment_count IS 'Numero de fragmentos persistentes incluidos en el agregado.';
