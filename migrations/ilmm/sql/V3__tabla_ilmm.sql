...
CREATE TABLE IF NOT EXISTS stg_ilmm (
    ...
    fecha            DATE         NOT NULL,
    indicador_id     SMALLINT     NOT NULL REFERENCES cat_ilmm_indicador(id),
    valor            NUMERIC(12,4),
    error_estandar   NUMERIC(12,4),
    CONSTRAINT uq_stg_ilmm UNIQUE (clave_municipio, fecha, indicador_id)
);
...
CREATE INDEX IF NOT EXISTS idx_stg_ilmm_indicador ON stg_ilmm (indicador_id);
