...
def utm13n_to_latlon(df: pd.DataFrame, x_col: str = "longitud", y_col: str = "latitud") -> pd.DataFrame:
    ...
    points = [Point(xy) for xy in zip(df.loc[utm_mask, x_col], df.loc[utm_mask, y_col])]
