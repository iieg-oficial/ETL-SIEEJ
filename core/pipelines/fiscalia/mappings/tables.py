...
from core.pipelines.fiscalia.attributes.delitos import IntregridadCorporal, IntegridadSexual, LaFamilia, ElPatrimonio
...
class BaseClass(Enum):
    ...
    def to_records(cls, _attr_name):
        return [{"id": c.id, _attr_name: c.attrtibute} for c in cls]
