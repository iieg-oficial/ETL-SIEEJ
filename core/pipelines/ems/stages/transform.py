...
from core.pipelines.ems.constants import FLOAT_COLS, NULL_VALUES
...
class EmsTransform(Stage):
    ...
    def _estatus_records(df: pd.DataFrame) -> list[dict]:
        ...
        the data would renumber the statuses that stg_ems already points at.
        """
