...
class StgEstJal(DenueBase):
    ...
    tipo_vial: Mapped[str | None] = mapped_column(Text, nullable=True)
    nom_vial: Mapped[str | None] = mapped_column(Text, nullable=True)
    numero_ext: Mapped[str | None] = mapped_column(Text, nullable=True)
    cod_postal: Mapped[str | None] = mapped_column(Text, nullable=True)
    telefono: Mapped[str | None] = mapped_column(Text, nullable=True)
    contacto_web: Mapped[str | None] = mapped_column(Text, nullable=True)
