...
class IimMunicipal(IntensidadMigratoriaBase):
    ...
    iaim: Mapped[float | None] = mapped_column(Float, nullable=True)
    gaim: Mapped[str | None] = mapped_column(Text, nullable=True)
    iim_dp2: Mapped[float | None] = mapped_column(Float, nullable=True)
    gim_dp2: Mapped[str | None] = mapped_column(Text, nullable=True)
