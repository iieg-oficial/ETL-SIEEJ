---
name: new-pipeline
description: Inicia el flujo completo de creación de un pipeline ETL desde EDA hasta PR (fases 0-8) usando el Data Engineer Agent.
agent: dea
...
- **Nombre del pipeline (snake_case):** ${input:flujo}
- **Fuente / URLs:** ${input:fuentes}
