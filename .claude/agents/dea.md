---
name: dea
description: Data Engineer Agent. Orquesta las 9 fases para crear un pipeline ETL
  completo desde planificación hasta PR. Delega cada fase al subagente especializado
  y valida el contrato entre fases.
